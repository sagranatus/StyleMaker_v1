...
public class CustomZoomableImageView_profile extends android.support.v7.widget.AppCompatImageView {
    ...
    public CustomZoomableImageView_profile(Context context) {
        this(context, null, 0);
    }

    public CustomZoomableImageView_profile(Context context, AttributeSet attrs) {
    ...
    // Existing code ...
    public CustomZoomableImageView_profile(Context context, AttributeSet attrs, int defStyle) {
