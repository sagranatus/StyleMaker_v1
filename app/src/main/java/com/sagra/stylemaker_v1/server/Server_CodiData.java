...
public class Server_CodiData {


    public static void insertCodi(final Context context, final String uid, final CodiData cData) {
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String top = cData.getTop();
                String bottom = cData.getBottom();
                String shoes = cData.getShoes();
                String outer = cData.getOuter();
                String bag = cData.getBag();
                String acc = cData.getAccessories();
                String tag =  cData.getTag();
                insertCodi_Connect(context, uid, cData);
    ...
    public static void insertCodi_Connect(Context context, final String uid, final CodiData codiData) {
