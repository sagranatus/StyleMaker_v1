package com.sagra.stylemaker_v1.filtering;
...
import com.sagra.stylemaker_v1.filtering.utils.SpacesItemDecoration;
...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.filter_fragment_filters_list, container, false);
        ...
        Runnable r = new Runnable() {
            public void run() {
                ...
                //    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), FilterActivity.IMAGE_NAME, 100, 100);
                    thumbImage = BitmapFactory.decodeFile(FilterActivity.IMAGE_PATH);
                } else {
