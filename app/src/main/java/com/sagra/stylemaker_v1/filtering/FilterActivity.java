...
import com.sagra.stylemaker_v1.filtering.utils.BitmapUtils;
...
public class FilterActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener, EditImageFragment.EditImageFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i1 = getIntent();
        info = i1.getStringArrayExtra("info");
        date = i1.getStringExtra("date");
        frommain = i1.getStringExtra("frommain");
...
*/
        ...
        Bitmap bitmap1 = BitmapFactory.decodeFile(info[4]);
        Bitmap bitmap2 = BitmapFactory.decodeFile(info[5]);
        Bitmap bitmap3 = BitmapFactory.decodeFile(info[6]);
        Bitmap bitmap4 = BitmapFactory.decodeFile(info[7]);
        Bitmap bitmap5 = BitmapFactory.decodeFile(info[8]);
        Bitmap bitmap6 = BitmapFactory.decodeFile(info[9]);

        icon1.setImageBitmap(bitmap1);
        icon2.setImageBitmap(bitmap2);
        icon3.setImageBitmap(bitmap3);
        icon4.setImageBitmap(bitmap4);
        icon5.setImageBitmap(bitmap5);
        icon6.setImageBitmap(bitmap6);
        loadImage();
    ...
    private void loadImage() {
      ...
      //  String path = Environment.getExternalStoragePublicDirectory(
            //   Environment.DIRECTORY_PICTURES) + File.separator + "Stylemaker" + File.separator + "saea.jpg";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.topmenu_filter, menu);
        return true;
    }
...
*/
    ...
    private void galleryAddPic(){
        ...
        Intent i2 = new Intent(FilterActivity.this, AddstyleActivity.class);
        i2.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i2.putExtra("imagepath", path);
        i2.putExtra("info", info);
        i2.putExtra("date", date);
        i2.putExtra("frommain", frommain);
        startActivity(i2);
    }
